...
echo "[PREVIEW] 검증 경로"
echo "[PREVIEW] 운영 루트(공개): https://everyonepr.com/"
echo "[PREVIEW] 운영 검수 URL: https://everyonepr.com/review"
echo "[PREVIEW] 운영 로그인 URL: https://everyonepr.com/login"
echo "[PREVIEW] 운영 회원가입 URL: https://everyonepr.com/signup"
echo "[PREVIEW] 운영 회원전용 URL: https://everyonepr.com/member/"
echo "[PREVIEW] 운영 관리자 URL: https://admin.everyonepr.com/"
...
echo "[PREVIEW] 운영 rewrite 점검: / -> public landing, /review -> review page, /login -> login modal entry, /signup -> signup modal entry"
