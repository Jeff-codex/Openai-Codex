...
export function buildRefundPolicyHtml() {
  return [
    "<h4>주문 결제 환불 규정(임시 안내문)</h4>",
    "<p>1. 결제 후 주문이 접수되면 작업 진행 상태에 따라 환불 가능 범위가 달라질 수 있습니다.</p>",
    "<p>2. 이미 송출이 완료되었거나 외부 집행이 완료된 주문은 환불이 제한될 수 있습니다.</p>",
    "<p>3. 결제 취소/환불은 관리자 확인 후 처리되며, 결제수단 정책에 따라 반영 시점이 다를 수 있습니다.</p>",
    "<p>4. 최종 환불 규정은 서비스 약관 및 운영정책의 최신 고지 내용을 따릅니다.</p>",
  ].join("");
}
